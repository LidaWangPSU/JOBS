...
The pre-computed TWAS cell type specific gene expression model weights could be downloaded [here](https://github.com/LidaWangPSU/JOBS/blob/main/example_data/)
...
#### JOBS Step 2: refine eQTLs estimation 
